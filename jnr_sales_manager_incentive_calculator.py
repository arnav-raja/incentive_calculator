...
st.set_page_config(page_title="JNR Sales Manager Incentive Calculator", page_icon="💎", layout="centered")
st.title("JNR Sales Manager Incentive Calculator")
...
st.success(f"JNR Sales Manager | Monthly Revenue: ₹{ar:,}")
